...
class PandaSim(object):
  ...
  def dmp_step(self, p_dmp, count,u_returned = 0, flag = False):
    #print(fl_taken)
    pos_dmp = p_dmp[count]
    ...
    for i in range(pandaNumDofs):
      if flag == False:
        ...
        self.bullet_client.setJointMotorControl2(self.panda, i, self.bullet_client.POSITION_CONTROL, u_returned[i],force = 0.)
  ...
  def step(self):
    ...
    b = self.bullet_client.getLinkState(self.panda, 6)
    return b[0], b[1]
